...
SpiderModelNormal::SpiderModelNormal(SpiderModelStateMachine* machine, SpiderModels* spidermodel):SpiderModelState(machine,spidermodel)
	,
	m_resources{nullptr},
	...
	m_shaderSet{}
{
	...
	m_shaderSet.pixelShader = ShaderManager::CreatePSShader(device, "ModelNormalPS.cso");
...
/// 事前更新
/// </summary>
void SpiderModelNormal::PreUpdate()
{
}
...
void SpiderModelNormal::Update(float deltaTime)
{
...
/// 事後更新
/// </summary>
void SpiderModelNormal::PostUpdate()
{
}
...
void SpiderModelNormal::Render(const Camera& camera)
{
