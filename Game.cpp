...
#include"Base/Tween/TweenManager.h"
...
void Game::Initialize(HWND window, int width, int height)
{
    ...
    */
    ...
    m_input = std::make_unique<DirectXInputs>(window);
    ...
    // ★追記ココまで↑↑↑★
    /*m_timer.SetTargetElapsedTicks(60);*/
   /* m_timer.SetFixedTimeStep(true);*/
}
...
void Game::Update(DX::StepTimer const& timer)
{
   ...
   /* if (m_input->IsKeyPress(DirectX::Keyboard::Escape))
    {
        PostQuitMessage(0);
    }*/
    // ★追記ココまで↑↑↑★
